...
| peek | peek.wav | Peek hold begins |
| settle | settle.wav | Peek release |
| fold | fold.wav | Muck throw (rope whoosh) |
...
| step | step.wav | Garden grass walk loop |
| arrive | arrive.wav | Avatar arrives |
| clouds | clouds.wav | Fog parts |
...
| garden-night-ambience | garden-night-ambience.wav | Garden table night (crickets) |
| garden-night-forest | garden-night-forest.wav | Garden table night (forest insects, queued with crickets) |
